...
?>
 ...
 <div class="container my-4">
  <div class="card shadow-lg p-4 col-lg-6 col-md-8 col-sm-12 mx-auto">

    <!-- Balance Card -->
    <div class="card bg-primary text-light mb-4">
      <div class="card-body text-center">
        <h6 class="mb-2">TOTAL BALANCE</h6>
        <h1 class="mb-3">₹<?php echo number_format($balance, 2); ?></h1>
        <div class="row">
          <div class="col-6">
            <h6 class="mb-1">INCOME</h6>
            <span class="text-info fw-bold">+₹<?php echo number_format($total_income, 2); ?></span>
          </div>
          <div class="col-6">
            <h6 class="mb-1">EXPENSE</h6>
            <span class="text-warning fw-bold">-₹<?php echo number_format($total_expanse, 2); ?></span>
          </div>
        </div>
      </div>
    </div>
    ...
    <form class="row g-3" id="myForm" name="myForm" action="" method="post">
      ...
      <!-- Transaction Type -->
      <div class="mb-3">
        <label class="form-label fw-bold">ADD TRANSACTION:</label>
        <div class="btn-group w-100" role="group" aria-label="Transaction type">
          <input type="radio" class="btn-check" name="type" id="expanse" value="0"                                                                                                                                                                                                                                                       <?php echo($type == 0) ? "checked" : ""; ?>>
          <label class="btn btn-outline-danger fw-bold" for="expanse">EXPENSE</label>

          <input type="radio" class="btn-check" name="type" id="income" value="1"                                                                                                                                                                                                                                                    <?php echo($type == 1) ? "checked" : ""; ?>>
          <label class="btn btn-outline-success fw-bold" for="income">INCOME</label>
        </div>
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="label" name="label" placeholder="Enter Label" value="<?php echo $label; ?>">
        <div id="labelError" class="text-danger small"></div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-3">
          ...
          <script>document.getElementById("category").value = "<?php echo $category; ?>";</script>
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <script>document.getElementById("paymentMode").value = "<?php echo $paymentMode; ?>";</script>
          <div id="paymentModeError" class="text-danger small"></div>
        </div>
        <div class="col-md-6 mb-3">
          <label for="datepicker" class="form-label fw-bold">Date:</label>
          <input type="date" class="form-control" id="datepicker" name="cdate" value="<?php echo $cdate; ?>">
